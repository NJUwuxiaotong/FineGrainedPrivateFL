...
class GradientReconstructor():
    ...
    def reconstruct(self, input_data, labels, img_shape=(3, 32, 32),
        ...
        if self.config['scoring_choice'] in ['pixelmean', 'pixelmedian']:
            ...
            with open(consts.INFO_FILE, "a+") as f:
                output_str = f'Choosing optimal result ...\n'
                f.write(output_str)
            ...
            with open(consts.INFO_FILE, "a+") as f:
                ...
                output_str = f'Optimal result score: {scores[optimal_index]:2.4f} \n'
                f.write(output_str)
        ...
        with open(consts.INFO_FILE, "a+") as f:
            output_str = f'Total time: {time.time()-start_time}.\n'
            f.write(output_str)

        return x_optimal.detach(), stats, optimal_score
    ...
    def _average_trials(self, x, labels, input_data, stats):
        ...
        with open(consts.INFO_FILE, "a+") as f:
            output_str = f'Optimal result score: {stats["opt"]:2.4f}\n'
            f.write(output_str)
