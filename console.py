...
if __name__ == "__main__":
    ...
    fl_clients = list()
    client_training_no = int(sys_args.client_no * sys_args.client_ratio)
    for i in range(sys_args.client_no):
        ...
        client_train_loader, client_train_info = \
            construct_data_loaders(client_data_subset, sys_args.batch_size)
        fl_client = FedAvgClient(setup, sys_args.model_name,
                                 ...
                                 sys_args.noise_dist,
                                 sys_args.broken_probability, sys_args.sigma,
                                 sys_args.batch_size, sys_args.grad_ratio)
    ...
    fl_server.train_model(fl_clients, False)
